...
TARGET_IMAGE="ghcr.io/one-covenant/basilica/basilica-api"
IMAGE_TAG="latest"
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        --help)
            ...
            echo "  --target-image TARGET     Target Docker image (default: ghcr.io/one-covenant/basilica/basilica-api)"
