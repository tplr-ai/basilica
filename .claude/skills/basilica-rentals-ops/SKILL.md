...
description: Route Basilica direct machine discovery, SSH access, volumes and rental cleanup tasks to the authoritative customer skill.
---

# Basilica Rentals

This checkout entry is a contributor routing adapter. For direct machine discovery, SSH access, volumes and rental cleanup,
...
and its **Rentals** section. The URL is usable without a checkout or installation.
