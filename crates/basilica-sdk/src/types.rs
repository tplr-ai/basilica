...
pub struct CreateInferencePipelineRequest {
    ...
    pub model: InferenceModelRequest,
    pub stages: InferenceStageSetRequest,
    #[serde(default)]
    pub coordinator: InferenceCoordinatorRequest,
    #[serde(default = "default_public")]
    pub public: bool,
}
...
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct InferenceModelRequest {
    #[serde(rename = "ref")]
...
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct InferenceStageSetRequest {
    pub count: u32,
    #[serde(default)]
    pub gpu: InferenceStageGpuRequest,
}

#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct InferenceStageGpuRequest {
...
impl Default for InferenceStageGpuRequest {
    fn default() -> Self {
        Self {
...
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct InferenceCoordinatorRequest {
    #[serde(default = "default_shard_image")]
    pub image: String,
    #[serde(default = "default_inference_port")]
    pub port: u32,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub draft_model_ref: Option<String>,
}

impl Default for InferenceCoordinatorRequest {
    fn default() -> Self {
        Self {
            image: default_shard_image(),
...
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct InferencePipelineResponse {
    pub id: String,
    pub instance_name: String,
    pub url: String,
    pub state: String,
    pub phase: String,
    pub stage_count: u32,
    pub receipt_verification: String,
}
...
fn default_shard_image() -> String {
    "ghcr.io/one-covenant/basilica/basilica-shard:latest".to_string()
}

fn default_inference_port() -> u32 {
    8000
}
